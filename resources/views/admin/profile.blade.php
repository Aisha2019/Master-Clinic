            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <form action="{{ route('admin.update.profile_picture') }}" class="update-profile-picture" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="file" class="btn btn-primary btn-block">Change Profile Photo</label>
                    </form>
        ...
        <div class="col-md-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#emails" data-toggle="tab">Emails</a></li>
                        ...
                        <div class="post">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group margin-bottom-none">
                                    <div class="col-sm-9">
                                        <input class="form-control input-sm" placeholder="Type a reply">
                                    </div>
                                    <div class="col-sm-3">
                                        <button type="submit" class="btn btn-danger pull-right btn-block btn-sm">Reply</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <div class="checkbox"><label><input type="checkbox"> I agree to the <a href="#">terms and conditions</a></label></div>
                                </div>
                            </div>
