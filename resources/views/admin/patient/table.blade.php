	...
	@endif
	        			...
	        			<table id="example1" class="table table-bordered table-striped">
			                ...
			                <tr>
			                  ...
			                  <th> <button type="button" class="btn btn-block btn-success btn-xs"> ADD </button> </th>
			                </tr>
			                </thead>
			                <tbody>
			                ...
			                <?php $patient = (object)$patient; ?>
			                  <tr>
								...
								<td><button type="button" class="btn btn-block btn-warning btn-xs">Update</button> <button type="button" class="btn btn-block btn-danger btn-xs">Delete</button> </td>
			                  </tr>
			              @endforeach
			                </tbody>
			                <tfoot>
