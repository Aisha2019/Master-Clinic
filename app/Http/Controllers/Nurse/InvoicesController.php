...
class InvoicesController extends Controller
{
    ...
    public function add()
    {
    	...
    	$admins = admin::all();
        return view('nurse.invoice.add', compact('clinics','nurses','patients','admins'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $invoice->save();
        return redirect('/nurse/invoice/view')->with('status' ,'Invoice Created Successfully!!');
    }
    ...
    public function view(Request $request)
    {
        ...
        return view('nurse.invoice.table',compact('invoices'));
    }
    ...
    public function edit(Request $request,receipt $invoice)
    {
        ...
        return view('nurse.invoice.update', compact('invoice','clinics','nurses','patients','admins'));
    }
    ...
    public function show(Request $request,receipt $invoice)
    {
        ...
        $invoice->date = Carbon::parse($invoice->day)->toDateString();
        $invoice->time = Carbon::parse($invoice->day)->format('h:i:s A');
        return view('nurse.invoice.show', compact('invoice','clinic','nurse','patient','admin'));  
    }
}
